...
# Only configure PostgreSQL if DATABASE_URL is actually set
if [ -n "$DATABASE_URL" ]; then
  echo "DATABASE_URL detected, configuring PostgreSQL..."
  ...
  echo "No DATABASE_URL found, using DB_TYPE=$DB_TYPE (SQLite)"
fi
